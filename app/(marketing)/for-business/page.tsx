    ...
    <div className="flex flex-col min-h-screen bg-white font-sans text-[#0d1619]">
      ...
      <header className="fixed top-0 w-full h-20 bg-white/90 backdrop-blur-md z-50 border-b border-gray-100 flex items-center px-6 lg:px-12 justify-between">
        ...
        <div className="flex items-center gap-4">
            ...
            <Button className="rounded-full bg-black text-white hover:bg-gray-800 h-10 px-6 text-sm font-bold">
                Join now
            </Button>
        </div>
      </header>
      ...
      <main className="pt-20">
            ...
            <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-8 max-w-xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                        <Button className="h-14 px-8 rounded-full bg-black text-white text-lg font-bold hover:scale-105 transition-transform">
                            Start for free
                        </Button>
        ...
        <section className="py-24 px-6 bg-black text-white text-center">
            <div className="max-w-3xl mx-auto space-y-8">
                ...
                <Button className="h-16 px-10 text-xl rounded-full bg-white text-black font-bold hover:bg-gray-200 hover:scale-105 transition-all">
                    Get started now
                </Button>
            </div>
        </section>
